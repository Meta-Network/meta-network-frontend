...
class HexagonRound extends PureComponent<IProps, IState> {
  ...
  render() {
  	...
  	return (
  		<g className={classNames('hexagon-group', this.props.className)}
