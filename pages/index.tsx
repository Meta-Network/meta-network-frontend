            ...
            ~isBookmark ?
              <g style={{ transform: 'translate(-10px, 30px)' }}>
                <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 5.55556C4 4.69645 4.69645 4 5.55556 4H13.3333C14.1924 4 14.8889 4.69645 14.8889 5.55556V18L9.44444 15.2778L4 18V5.55556Z" stroke="#FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </g> : null
          }
        </>
